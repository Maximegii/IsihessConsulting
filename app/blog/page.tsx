export const metadata = {
  title: "Blog | Synego",
  description: "Articles, conseils et témoignages sur le bien-être, la thérapie, le développement personnel et les pratiques alternatives.",
  keywords: [
...
import BlogClient from "../../components/blogpage";
